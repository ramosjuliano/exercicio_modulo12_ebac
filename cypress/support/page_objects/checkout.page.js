class CheckoutPage {
    ...
    adicionarDadosCheckout(nome, sobrenome, empresa, pais, endereco, numero, cidade, estado, cep, telefone, email, mensagemComentario){
        ...
        cy.get('#order_comments').clear().type(mensagemComentario)
